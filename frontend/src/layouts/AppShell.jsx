  ...
  return <div className="command-grid min-h-screen lg:flex">
    <aside className="sticky top-0 z-20 border-b border-white/10 bg-slate-950 p-4 text-white shadow-2xl lg:h-screen lg:w-80 lg:border-b-0 lg:border-r">
      ...
      <div className="relative">
        <div className="mb-8 flex items-center gap-3 rounded-[1.75rem] border border-white/10 bg-white/8 p-3 shadow-soft backdrop-blur"><div className="grid h-13 w-13 place-items-center rounded-2xl bg-gradient-to-br from-cyan-400 via-brand-500 to-violet-600 text-white shadow-lg shadow-cyan-500/20"><Activity /></div><div><h1 className="text-2xl font-black tracking-tight">AssetFlow</h1><p className="text-xs font-semibold uppercase tracking-[0.18em] text-cyan-200/80">ERP Command OS</p></div></div>
